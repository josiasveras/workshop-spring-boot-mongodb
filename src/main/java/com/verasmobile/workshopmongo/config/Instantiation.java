package com.verasmobile.workshopmongo.config;
...
import com.verasmobile.workshopmongo.dto.AuthorDTO;
import com.verasmobile.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("27/11/2021"), "Bom dia", "Acordei feliz hoje!", new AuthorDTO(maria));
